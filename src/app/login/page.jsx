        ...
        <div className="w-[80%] mt-[3vw] sm:mt-[1vw]">
          <div className="relative w-full h-[7vw] sm:h-10 mt-[1vw]">
            <input
              ...
              className="peer w-full h-full bg-zinc-700 text-blue-gray-700 font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50  transition-all duration-300 ease-in-out placeholder-shown:border focus:border-2 focus:border-t-transparent text-[1.4vw] px-[1vw] py-[1.45vw] rounded-[1vw] sm:rounded-[0.5vw] focus:border-blue-600 border-transparent"
              placeholder=" "
            />
